      ...
      {totpEnabled ? (
        <form onSubmit={disable} className="mt-3 space-y-3">
          ...
          <label className="block text-sm">
            ...
            <input required type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full max-w-xs rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" />
          </label>
        ...
        <form onSubmit={confirmSetup} className="mt-3 space-y-3">
          ...
          <label className="block text-sm">
            ...
            <input required value={code} onChange={(e) => setCode(e.target.value)} placeholder="123456" className="w-full max-w-xs rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500" />
          </label>
          {error && <p className="text-sm text-red-600">{error}</p>}
        ...
        <div className="mt-3">
          ...
          <button onClick={startSetup} className="mt-3 rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700">
            Set up 2FA
          </button>
        </div>
      )}
